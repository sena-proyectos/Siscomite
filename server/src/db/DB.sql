...
CREATE TABLE `usuarios` (
  ...
  KEY `fk_roles` (`id_roles`),
  CONSTRAINT `fk_roles` FOREIGN KEY (`id_roles`) REFERENCES `roles` (`id_roles`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-07-19 14:14:17
