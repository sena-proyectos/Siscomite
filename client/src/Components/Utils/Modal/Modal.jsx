  ...
  return (
    <>
      <main className="top-0 left-0 h-screen w-full bg-[#0000006a] z-10 fixed flex items-center justify-center backdrop-blur-[3px] ">
        <section className="bg-white p-[2rem] border-t-[4px] border-[#2e323e] w-[35%] max-w-[1000px] rounded-2xl " style={{ animation: "bounce 0.8s ease-in-out" }}>
